...
# https://github.com/w-okada/voice-changer/blob/08d07c599718a1395ae6a4d1eda71de1f8defd88/server/voice_changer/VoiceChanger.py
...
from VoiceChangerModel import VoiceChangerModel, AudioInOut
import time
